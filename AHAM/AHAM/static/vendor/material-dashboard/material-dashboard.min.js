...
document.addEventListener("DOMContentLoaded", function () {
    ...
    0 != document.querySelectorAll(".input-group").length && (allInputs = document.querySelectorAll("input.form-control")).forEach(function(e) { if(e.type=="date"){setAttributes(e, { onfocus: "focused(this,'date')", onfocusout: "defocused(this,'text')",type:"text",placeholder:"e.g. 01-Jan-2023" });}else{setAttributes(e, { onfocus: "focused(this)", onfocusout: "defocused(this)" })}}),
...
function initNavs() {
    total.forEach(function (l, e) {
        ...
        (s.style.padding = "0px"),
            ...
            (s.style.height = l.querySelector("li:nth-child(1)").offsetHeight + "px"),
                ...
                if (i) {
                    ...
                    l.querySelector("li:nth-child(" + n + ") .nav-link").onclick = function () {
                        ...
                        if (l.classList.contains("flex-column")) {
                            ...
                            (s.style.transform = "translate3d(0px," + e + "px, 0px)"), (s.style.height = l.querySelector("li:nth-child(" + t + ")").offsetHeight+"px");
                        } else {
            ...
            (   
                l.querySelectorAll("li").forEach(function(el,i){
                let n = i+1;
                l.querySelector("li:nth-child(" + n + ") .nav-link").onclick = function () {
                    s = l.querySelector(".moving-tab");
                    let e = 0;
                    if (l.classList.contains("flex-column")) {
                        for (var t = 1; t <= i; t++) e += l.querySelector("li:nth-child(" + t + ")").offsetHeight;
                        (s.style.transform = "translate3d(0px," + e + "px, 0px)"), (s.style.height = l.querySelector("li:nth-child(" + t + ")").offsetHeight+"px");
                    } else {
                        for (t = 1; t <= i; t++) e += l.querySelector("li:nth-child(" + t + ")").offsetWidth;
                        (s.style.transform = "translate3d(" + e + "px, 0px, 0px)"), (s.style.width = l.querySelector("li:nth-child(" + n + ")").offsetWidth + "px");
                    }
                }
        ...
        total.forEach(function (a, e) {
            ...
            if (l) {
                ...
                if (a.classList.contains("flex-column")) {
                    ...
                    (n.style.transform = "translate3d(0px," + t + "px, 0px)"), (n.style.width = a.querySelector("li:nth-child(" + i + ")").offsetWidth + "px"), (n.style.height = a.querySelector("li:nth-child(" + s + ")").offsetHeight + "px");
                } else {
